...
execute as @s if entity @s[scores={holding=16}] run function golf:hold_detection/replace_iron
execute as @s if entity @s[scores={holding=20}] run function golf:hold_detection/replace_diamond
