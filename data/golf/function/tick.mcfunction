...
execute as @e[tag=ball, tag=moving] if predicate golf:invalid_block run function golf:position_detection/is_invalid
execute as @e[tag=ball, tag=moving] if predicate golf:valid_block run function golf:position_detection/is_valid