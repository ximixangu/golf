execute as @e[tag=ball] at @s if block ~ ~-1 ~ blue_ice run function golf:boost
...
execute as @e[tag=ball] if score @s velocity.x matches 0 run function golf:physics_process_x
execute as @e[tag=ball] if score @s velocity.z matches 0 run function golf:physics_process_z
