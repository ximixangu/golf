...
execute as @e[tag=ball] if score @s velocity.x matches 0 run function golf:physics/physics_process_x
execute as @e[tag=ball] if score @s velocity.z matches 0 run function golf:physics/physics_process_z
