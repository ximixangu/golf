...
execute at @s run summon allay ~ ~-1 ~ {attributes:[{id:"minecraft:generic.scale",base:0.0625}],NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:-1,show_particles:0b,show_icon:0b,ambient:0b}]}
...
execute if entity @s[team=white] as @e[team=,type=allay] run team join yellow